...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { location_id: @warehouse.location_id, warehousename: @warehouse.warehousename } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { location_id: @warehouse.location_id, warehousename: @warehouse.warehousename } }
